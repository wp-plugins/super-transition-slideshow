...
function sts_admin_option() 
{
    ...
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/29/super-transition-slideshow/'>click here</a> to post suggestion or comments or how to improve this plugin. || 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/29/super-transition-slideshow/'>click here</a> to see LIVE demo. || 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/29/super-transition-slideshow/'>click here</a> 
	...
	4. in default am using 200 X 150 size images <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/29/super-transition-slideshow/'>LIVE DEMO</a>.<br>
    <br></p>
	<?php
	echo "</div>";
}
