...
function sts_admin_option() 
{
	...
	echo '<p>Default Image directory:<br>wp-content/plugins/super-transition-slideshow/images/ <br>You have to change this folder location to your original location. (Best practice is dont upload your original image into this default folder instead you change this default path to original path)</p>';
    ...
    <ol>
    	<li><a href="http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/" target="_blank">Drag and drop the widget</a></li>
    	<li><a href="http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/" target="_blank">Short code for pages and posts</a></li>
    	<li><a href="http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/" target="_blank">Add directly in the theme</a></li>
    </ol>
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/'>Click here</a> to post suggestion/comments/feedback. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/'>Click here</a> to see live demo. <br> 
	<h2><?php echo wp_specialchars( 'Note' ); ?></h2>
	...
	4. in default am using 200 X 150 size images <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/'>LIVE DEMO</a>.<br>
    <br></p>
	<?php
	echo "</div>";
}
...
function sts_control()
{
	...
	<h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>www.gopiplus.com</a>. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/super-transition-slideshow/'>Click here</a> for more help and live demo. <br> 
	<?php
}
...
function sts_widget_init() 
{
	...
	{
		register_widget_control(array('Super transition slideshow', 'widgets'), 'sts_control');
	} 
}
